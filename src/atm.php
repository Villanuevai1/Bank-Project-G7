...
?>
             ...
             <a href="atm_deposit.php" class="btn btn-primary">deposit</a>
                <a href="atm_withdraw.php" class="btn btn-primary">withdraw</a>
                   <a href="atm_transfer.php" class="btn btn-primary">transfer</a>
                   <br>
                   <br>
                   <hr>
                   <br>
